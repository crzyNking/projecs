        ...
        <nav className="hidden md:flex gap-8 items-center absolute left-1/2 -translate-x-1/2">
          ...
          <div ref={programsRef} className="relative">
            <button
              ...
              className={`text-[13.5px] font-normal transition-colors cursor-pointer flex items-center gap-1 ${(isActive('/programs') || isActive('/senior-high')) ? 'text-white border-b-2 border-white pb-1' : programsOpen ? 'text-white' : 'text-[#cbd5e1] hover:text-white'}`}
            >
              Programs
