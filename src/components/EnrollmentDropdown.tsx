...
export default function EnrollmentDropdown({ open, onClose }: EnrollmentDropdownProps) {
  ...
  return (
    <div className="absolute top-full left-1/2 -translate-x-1/2 pt-3 z-[60]">
      {/* Desktop */}
      <div className="hidden md:block relative w-[min(780px,calc(100vw-2rem))] bg-[#061830]/97 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-5 xl:p-7">
            ...
            <div className="grid grid-cols-2 gap-3">
              {k12Cards.map((card) => (
                <button
                  ...
                  className={`group relative bg-gradient-to-b ${card.bg} rounded-xl h-[130px] border border-white/20 overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 hover:border-white/50 hover:shadow-[0_6px_20px_rgba(0,0,0,0.25)] transition-all duration-200 flex flex-col justify-between items-start p-3 cursor-pointer`}
                >
