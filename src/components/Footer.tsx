export default function Footer() {
  return (
    <footer className="bg-[#03112d] text-[#94a3b8] text-[11.5px] border-t border-white/5 px-4 py-6 md:px-12 md:py-8">
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="break-all">cebueasterncollege1915@yahoo.com</span>
          </div>
          <div className="flex items-center gap-2.5">
            <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
