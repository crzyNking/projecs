      ...
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 items-start text-center sm:text-left">
        <div className="flex flex-col gap-2.5 items-center sm:items-start">
          <div className="flex items-center gap-2.5">
            ...
            <span>{school?.phone || '(032) 256 2523'}</span>
          </div>
          <div className="flex items-center gap-2.5">
            <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
            </svg>
            <span className="break-all">{school?.email || 'cebueasterncollege1915@yahoo.com'}</span>
          </div>
          <div className="flex items-center gap-2.5">
            <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <span className="break-words">{school?.address || 'LEON KILAT ST., Cebu City, Philippines, 6000'}</span>
          </div>
        </div>

        <div className="text-center order-last sm:order-none">
          <div className="text-white text-xs font-bold mb-2.5 sm:hidden">Social Media</div>
          <div className="flex gap-3 justify-center mb-3 sm:mb-0 sm:hidden">
            {[
