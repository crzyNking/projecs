...
export default function Programs() {
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#333333] overflow-x-hidden">
      ...
      {/* CTA */}
      <section className="py-10 sm:py-[50px] bg-[#031548] text-center text-white px-4">
        ...
        <Link to="/" className="inline-block bg-white text-[#031548] font-bold text-[13px] px-6 py-2.5 rounded-md hover:bg-[#f1f5f9] transition-colors">
          Sign Up Now
        </Link>
      </section>
