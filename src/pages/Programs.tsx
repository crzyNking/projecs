          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {collegePrograms.map((prog) => (
                <Link to="/senior-high" key={prog.name} className="flex items-center justify-between rounded-lg px-3.5 py-2.5 transition-all hover:-translate-y-0.5 hover:shadow-md cursor-pointer" style={{ background: 'linear-gradient(90deg, #dbe2ef 0%, #e2e8f0 100%)' }}>
