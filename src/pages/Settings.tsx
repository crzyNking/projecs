          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
            ...
            <div className="space-y-4">
              {notifications.map((notif) => (
                <div key={notif.key} className="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/[0.04]">
                  <div>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      preferences?.[notif.key] ?? true ? 'bg-purple-500' : 'bg-gray-700'
                    }`}
                  >
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="flex w-full items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:bg-white/[0.04] transition-colors"
              >
