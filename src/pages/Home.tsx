...
export function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#333333] overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="bg-[#03112d] text-[#94a3b8] text-[11.5px] border-t border-white/5" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', padding: '30px 50px' }}>
        ...
        <div className="text-center self-center">
          &copy; 2026 Cebu Eastern College. All rights reserved.
        </div>
