...
const campusData: Record<string, {
  ...
  main: {
    ...
    heroImg: 'https://placehold.co/1200x400/38a0f4/ffffff?text=CEBU+EASTERN+COLLEGE',
    ...
    zones: [
      {
        img: 'https://placehold.co/600x400/38a0f4/ffffff?text=CEBU+EASTERN+COLLEGE',
        tag: 'ZONE 01',
      ...
      <div className="min-h-screen bg-[#0b1f40] overflow-x-hidden">
        ...
        <main className="flex items-center justify-center py-20">
          <div className="text-center">
            ...
            <button onClick={() => navigate('/')} className="text-[#a8c4e6] underline hover:text-white transition-colors">Return Home</button>
          </div>
        </main>
        <Footer />
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#0b1f40] overflow-x-hidden">
      ...
      <main className="pt-[72px] max-w-[1000px] mx-auto px-4 sm:px-5 pb-10">
        {/* Hero Section */}
        <section className="bg-white rounded-xl overflow-hidden mb-8 sm:mb-10 shadow-[0_4px_12px_rgba(0,0,0,0.15)]">
        ...
        {/* Location Section */}
        <section className="bg-white rounded-xl overflow-hidden mb-8 sm:mb-10 shadow-[0_4px_12px_rgba(0,0,0,0.15)] flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-5 sm:p-8 border-t md:border-t-0 md:border-l border-[#e2e8f0]">
            <img src={campus.mapImg} alt="Map" className="w-full h-[200px] sm:h-[250px] object-cover border border-[#e2e8f0] rounded-lg" />
          </div>
        </section>

        {/* Zones Section */}
        <section className="bg-white rounded-xl overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.15)] px-5 py-10 sm:px-12 sm:py-14">
