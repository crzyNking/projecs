    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <Link to="/admin/enrollments" className="text-xs text-[#0b1f40] font-medium hover:underline">
            View All
          </Link>
        </div>
        {recentEnrollments.length === 0 ? (
          <div className="px-6 py-10 text-center text-sm text-gray-400">No enrollments yet</div>
        ) : (
                ...
                {recentEnrollments.map((enrollment) => {
                  ...
                  return (
                    <tr key={enrollment.id} className="border-b border-gray-50 hover:bg-gray-50">
                      <td className="px-6 py-3 font-medium text-gray-900">{studentName}</td>
